...
if test "$PHP_INSPECTOR" != "no"; then
  PHP_NEW_EXTENSION(inspector, php_inspector.c src/file.c src/class.c src/method.c src/function.c src/instruction.c src/operand.c src/break.c src/frame.c, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1)
